...
export class AdminCoursesService {
  ...
  createCourse(course: Course): Observable<{ ok: boolean; message: string; id?: number }> {
  ...
  updateCourse(id: number, updatedCourse: Course): Observable<{ ok: boolean; message: string }> {
  ...
  deleteCourse(id: number): Observable<{ ok: boolean; message: string }> {
