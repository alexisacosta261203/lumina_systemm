...
import { MyCoursesPage } from './features/purchase/pages/my-courses-page/my-courses-page';
...
import { MyCourseDetailPage } from './features/purchase/pages/my-course-detail-page/my-course-detail-page';
...
export const routes: Routes = [
  ...
  { path: 'mis-cursos', component: MyCoursesPage },
  { path: 'mis-cursos/:id', component: MyCourseDetailPage },
